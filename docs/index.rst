...
.. image:: https://github.com/rsp2k/django-guest-user2/actions/workflows/lint.yml/badge.svg
   :target: https://github.com/rsp2k/django-guest-user2/actions/workflows/lint.yml
   :alt: Code Lint

.. image:: https://github.com/rsp2k/django-guest-user2/actions/workflows/test.yml/badge.svg
   :target: https://github.com/rsp2k/django-guest-user2/actions/workflows/test.yml
   :alt: Python Tests
...
.. note::
   ...
   **Repository Notice**: This repository (``django-guest-user2``) is a maintained 
   fork of the original `julianwachholz/django-guest-user <https://github.com/julianwachholz/django-guest-user>`_
   ...
   and expanded Django/Python version support. The "2" suffix distinguishes 
   this maintained version from the original.
...
3. **Current maintained fork**: `rsp2k/django-guest-user2`_ - ongoing maintenance and improvements
...
.. _rsp2k/django-guest-user2: https://github.com/rsp2k/django-guest-user2
...
- `GitHub Repository <https://github.com/rsp2k/django-guest-user2>`_
- `5 Steps Quickstart <https://github.com/rsp2k/django-guest-user2#-quick-start>`_
- `How to Contribute <https://github.com/rsp2k/django-guest-user2/blob/main/CONTRIBUTING.md>`_
- `Issues & Support <https://github.com/rsp2k/django-guest-user2/issues>`_
